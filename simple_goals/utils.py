...
def set_value(str_keys, vec, key, val):
    vec[0, str_keys.index(key)] = val
    return vec
...
def xavier_initialization(dimensions):
    ...
    hb = np.sqrt(6. / (dimensions[0] + dimensions[1]))
    lb = -hb
...
class RingBuffer:  # shamelessly taken from https://www.oreilly.com/library/view/python-cookbook/0596001673/ch05s19.html
