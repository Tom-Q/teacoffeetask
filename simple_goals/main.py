...
#pnas2018.make_rdm_multiple('pnas_cewgoals_CWCSTWTS', 100, with_goals=True, title="pnas_cewgoals_CWCSTWTS 2020-09-16")  # reuse that 'pnas_goals_ce_5000' for probas with goals
